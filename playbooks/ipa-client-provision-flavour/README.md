...
ansible-playbook \
  -e '{
        ...
        "tf_project_path":"~/ipa-client-1/ewc-tf-module-openstack-compute",
...
| tf_project_path | path to terraform module directory. Example: `~/ipa-client-1/ewc-tf-module-openstack-compute` | `string` | n/a | yes |
| app_name_override | application name, used as prefix in the full instance name. Example: `ipa` | `string` | n/a | yes |
| instance_name_override| name of the instance, used in the full instance name.  Example: `client` | `string` | n/a | yes |
...
This is due to constrains imposed by requirement [ewc-ansible-role-ipa-client-enroll](https://github.com/ewcloud/ewc-ansible-role-ipa-client-enroll).
