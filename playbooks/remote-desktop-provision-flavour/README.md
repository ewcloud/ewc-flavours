# Remote desktop provision flavour
...
```bash
ansible-playbook remote-desktop-provision-flavour.yml
```
...
ansible-playbook \
  -e '{
        ...
        "tf_project_path":"~/x2go-server-1/ewc-tf-module-openstack-compute",
        "app_name_override":"x2go",
  ...
  remote-desktop-provision-flavour.yml
```
## Inputs
...
| tf_project_path | path to terraform module directory. Example: `~/x2go-server-1/ewc-tf-module-openstack-compute` | `string` | n/a | yes |
| app_name_override | application name, used as prefix in the full instance name. Example: `x2go` | `string` | n/a | yes |
...
## Requirements
> ⚠️ Only RockyLinux 8.10 VM images are currently supported.
This is due to constrains imposed by requirement [ewc-ansible-role-remote-desktop](https://github.com/ewcloud/ewc-ansible-role-remote-desktop).

> 💡 A VM plan with at least 4GB of RAM is recommended. This is due to 
constrains imposed by requirement [ewc-ansible-role-remote-desktop](https://github.com/ewcloud/ewc-ansible-role-remote-desktop).
